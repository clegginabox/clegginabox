...
### Core & Frameworks
[![Backend](https://skillicons.dev/icons?i=php,symfony,laravel,python,nodejs,nestjs,js,ts&theme=dark)](https://skillicons.dev)

### Data & Concurrency
[![Data](https://skillicons.dev/icons?i=mysql,postgres,redis,rabbitmq,elasticsearch,dynamodb,mongodb,sqlite&theme=dark)](https://skillicons.dev)

### Infrastructure & DevOps
[![DevOps](https://skillicons.dev/icons?i=aws,terraform,docker,ansible,cloudflare,nginx,linux,bash,jenkins&theme=dark)](https://skillicons.dev)

### Specialized & Tools
[![Tools](https://skillicons.dev/icons?i=phpstorm,git,github,sentry,postman,pytorch,sklearn,selenium,react&theme=dark)](https://skillicons.dev)



<!--
**clegginabox/clegginabox** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
